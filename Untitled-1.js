        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Charger le profil utilisateur et la progression s'ils existent
            loadUserData();
        ...
        function updateMusicSource() {
            ...
            switch (currentMusic) {
                case 'study':
                    ...
                    break;
                case 'relax':
                    backgroundMusic.src = "https://assets.mixkit.co/music/preview/mixkit-dreaming-big-31.mp3";
                    break;
                case 'focus':
            ...
            // Réinitialiser et jouer si activé
            if (musicEnabled) {
